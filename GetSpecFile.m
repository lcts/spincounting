   ...
   case {'.akku', '.ch1', '.ch2'}
	 ...
	 if ~ISCOMMENT
	    ...
	    % Result: Only patterns that start with freq but do not later match 'error' are matched.
	       ...
	       params.Frequency = str2num(params.Frequency{1});
